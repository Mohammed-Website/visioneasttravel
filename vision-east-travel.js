...
const sectionData = [
    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-موسكو/1.jpg', 'عرض موسكو - 7 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/عروض-موسكو/2.jpg', 'عرض موسكو - 6 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/عروض-موسكو/3.jpg', 'إجازة منتصف الفصل الثاني - 7 أيام'],
    },

    {
        title: 'عروض فرنسا',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-فرنسا/1.jpg', 'فرنسا & بلجيكا | باريس - بروكسل'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-لندن/1.jpg', 'عرض لندن - 6 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/عروض-لندن/2.jpg', 'عرض لندن - 7 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/عروض-لندن/3.jpg', 'لندن 5 أيام - عرض محدود'],
    },

    {
        title: 'عروض القاهرة',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-القاهرة/1.jpg', 'عرض القاهرة -  5 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/عروض-القاهرة/2.jpg', 'عرض القاهرة -  5 أيام'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-اسطنبول/1.jpg', 'عرض اسطنبول -  5 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/عروض-اسطنبول/2.jpg', 'عرض اسطنبول -  6 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/عروض-اسطنبول/3.jpg', 'عرض اسطنبول -  6 أيام'],
        image_4: ['عروض-شركة-رؤيا-الشرق/عروض-اسطنبول/4.jpg', 'عرض اسطنبول -  5 أيام'],
    },

    {
        title: 'عروض اسبانيا',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-اسبانيا/1.jpg', 'عرض اسبانيا - مدريد & برشلونه'],
    },

    {
        title: 'عروض النمسا',
        image_1: ['عروض-شركة-رؤيا-الشرق/عروض-النمسا/1.jpg', 'النمسا & التشيك | فيينا - براغ'],
        image_3: ['عروض-شركة-رؤيا-الشرق/عروض-النمسا/2.jpg', 'النمسا & هنغاريا | فيينا - بودابست'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966597578685?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/visioneasttravel/${encodeURIComponent(src)}`;
