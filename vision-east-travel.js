...
const sectionData = [
    {
        title: 'أحدث العروض',
        image_1: ['عروض-شركة-رؤيا-الشرق/احدث-العروض/1.jpg', 'رحلة عيد الفطر | براغ 6 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/احدث-العروض/2.jpg', 'رحلة عيد الفطر | ايطاليا & سويسرا 7 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/احدث-العروض/3.jpg', 'رحلة عيد الفطر | المانيا & النمسا 6 أيام'],
        image_4: ['عروض-شركة-رؤيا-الشرق/احدث-العروض/4.jpg', 'رحلة لندن | 6 أيام'],
        image_5: ['عروض-شركة-رؤيا-الشرق/احدث-العروض/5.jpg', 'رحلة عيد الفطر | موسكو 7 أيام'],
    },

    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-رؤيا-الشرق/موسكو/1.jpg', 'رحلة موسكو | 7 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/موسكو/2.jpg', 'رحلة موسكو | 6 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/موسكو/3.jpg', 'رحلة إجازة منتصف الفصل الثاني | 7 أيام'],
    },

    {
        title: 'عروض فرنسا',
        image_1: ['عروض-شركة-رؤيا-الشرق/فرنسا/1.jpg', 'رحلة فرنسا & بلجيكا | 7 أيام'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-رؤيا-الشرق/لندن/1.jpg', 'رحلة لندن | 6 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/لندن/2.jpg', 'رحلة لندن | 7 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/لندن/3.jpg', 'رحلة لندن 5 أيام | عرض محدود'],
    },

    {
        title: 'عروض القاهرة',
        image_1: ['عروض-شركة-رؤيا-الشرق/القاهرة/1.jpg', 'رحلة القاهرة | 5 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/القاهرة/2.jpg', 'رحلة القاهرة | 5 أيام'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-رؤيا-الشرق/اسطنبول/1.jpg', 'رحلة اسطنبول | 5 أيام'],
        image_2: ['عروض-شركة-رؤيا-الشرق/اسطنبول/2.jpg', 'رحلة اسطنبول | 6 أيام'],
        image_3: ['عروض-شركة-رؤيا-الشرق/اسطنبول/3.jpg', 'رحلة اسطنبول | 6 أيام'],
        image_4: ['عروض-شركة-رؤيا-الشرق/اسطنبول/4.jpg', 'رحلة اسطنبول | 5 أيام'],
    },

    {
        title: 'عروض اسبانيا',
        image_1: ['عروض-شركة-رؤيا-الشرق/اسبانيا/1.jpg', 'رحلة اسبانيا - مدريد & برشلونه'],
    },

    {
        title: 'عروض النمسا',
        image_1: ['عروض-شركة-رؤيا-الشرق/النمسا/1.jpg', 'رحلة النمسا & التشيك | فيينا - براغ'],
        image_3: ['عروض-شركة-رؤيا-الشرق/النمسا/2.jpg', 'رحلة النمسا & هنغاريا | فيينا - بودابست'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966597578685?text=💎%20طلب%20حجز%20عرض%20جديد%20💎%0A%0Aسلام%20عليكم،%20حاب%20أسأل%20عن%20عرض%0A*${encodeURIComponent(text)}*%0Aوحاب%20أعرف%20تفاصيل%20أكثر%20عن%20عروضكم%20المشابهة.%0A%0A🔗%20رابط%20صورة%20العرض:%0Ahttps://mohammed-website.github.io/visioneasttravel/${encodeURIComponent(src)}%0A%0Aبإنتظار%20ردكم%20وشكرًا%20لكم`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966597578685";
